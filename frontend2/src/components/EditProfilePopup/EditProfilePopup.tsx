...
import { useUpdateProfileInfoMutation } from '../../features/app-data-api/app-data-api-slice';
import { useUserDetails } from '../../hooks/hooks-user-data';
...
function EditProfilePopup() {
	...
	useEffect(() => {
		if (isOpen && getUserDetailsIsSuccess && userDetails) {
			setValues({
				...values,
