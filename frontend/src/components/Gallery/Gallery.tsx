...
import { useGetCardsQuery } from '../../features/app-data-api/app-data-api-slice';
import Card from '../Card/Card';
import { useUserId } from '../../hooks/hooks-user-data';
import GallerySkeleton from './GallerySkeleton/gallery-skeleton';
...
function Gallery({ children }: { children: ReactNode }) {
	...
	return (
		<section className="gallery">
			{(cardsAreLoading || userIdIsLoading) && <GallerySkeleton length={6} />}
